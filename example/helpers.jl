...
function scatterBB!(fig, sol=solution_gt; scatterlabels = [0.0, 0.8, 1.4, 1.9, 2.3], textsize=12)
...
# function update_params!(sys::CombinedEquationSystem, p)
...
#     a=sys.f_a, b=sys.f_b,
#     W_az=sys.W_az, W_ba=sys.W_ba, W_bz=sys.W_bz, W_za=sys.W_za, W_zb=sys.W_zb, W_zz=sys.W_zz, b_a=sys.b_a, b_b=sys.b_b, b_z=sys.b_z)

#     υ_a = W_az*υ + b_a
#     # the general case would be `a(sys.γ_a, υ_a)` but we do some simplifications here (directly pass in u, p, t)
#     a(sys.γ_a, υ_a, x_d, u, p, t)

#     υ_b = W_ba*sys.γ_a + W_bz*υ + b_b
#     # the general case would be `b(sys.γ_b, υ_b)` but we do some simplifications here (directly pass in u, p, t)
#     b(sys.γ_b, υ_b, x_d, u, p, t)

#     γ[:] = W_za*sys.γ_a + W_zb*sys.γ_b + W_zz*υ + b_z
#     nothing
# end
...
#     gt.fct = HUDADE.rebuild(gt.fct; f=gt_f)
